...
foreach ($websites as $website) {
    ...
    if($email == "" || !testEmail($email)){
        if(testEmail("info@".getDomain($website)) && getDomain($website) != "facebook.com" && getDomain($website) != "tripadvisor.it" && getDomain($website) != "business.site" && getDomain($website) != "email.com" && getDomain($website) != "wordpress.com" && getDomain($website) != "jimdo.com" && getDomain($website) != "wixsite.com" && getDomain($website) != "pec.it" && getDomain($website) != "titrovo.it"){
...
function findEmail($url){
    ...
    foreach (array_unique($matches[0]) as $match) {
        ...
        if(filter_var($match, FILTER_VALIDATE_EMAIL) && $match != "email@mail.com" && $match != "info@icvda.it" && $ext != "png" && $ext != "jpg" && $ext != "gif" && !strpos($match, "@pec.") && !strpos($match, "@facebook.com") && !strpos($match, "business.site") && !strpos($match, "@email.com") && !strpos($match, "@wordpress.com") && !strpos($match, "@jimdo.com") && !strpos($match, "@wixsite.com") && !strpos($match, "@titrovo.it") && !strpos($match, "@legalmail.it")){
            $email = $match;
        }
    }
    return $email;
